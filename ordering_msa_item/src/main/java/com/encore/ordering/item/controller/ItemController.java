...
public class ItemController {
    ...
    public ResponseEntity<CommonResponse>  updateQuantity (@RequestBody ItemQuantityUpdateDto dto){
        itemService.updateQuantity(dto);
        return new ResponseEntity<>(
                new CommonResponse(HttpStatus.OK,"item successfully delete", dto.getId())
                , HttpStatus.OK);
    }

    @GetMapping("/item/{id}")
    public ItemResDto findById(@PathVariable Long id) {
